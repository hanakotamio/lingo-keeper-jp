 ...
 * Natural Japanese questions with English explanations
 */
async function updateQuizzes() {
  console.log('Updating quizzes for Story 10 to natural Japanese...');
  ...
  try {
    ...
    console.log('✓ Created Quiz 4: 元気ない');
    ...
    console.log('\n✅ All quizzes updated to natural Japanese for Story 10!');
  } catch (error) {
