...
async function main(): Promise<void> {
  ...
  // Clear existing data (for development)  await prisma.quizChoice.deleteMany();
  ...
  await prisma.chapter.createMany({
    data: [
      ...
      },
      {
        ...
        content_en: 'I came to the register. The staff said "Welcome." I pay the money. The staff asked "Would you like chopsticks?" I answer in Japanese. I said "Yes, please."',
      },
      {
        chapter_id: 'ch-3-5',
        story_id: story3.story_id,
